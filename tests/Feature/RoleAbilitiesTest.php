...
class RoleAbilitiesTest extends TestCase
{
    ...
    public function an_admin_can_add_an_ability_to_a_role(): void
    {
        ...
        $this->post(route('api.role-abilities.store', ['role' => $role->id]), ['data' => [$ability->toArray()]])
            ->assertSuccessful();
    ...
    public function an_admin_can_add_multiple_abilities_to_a_role(): void
    {
        ...
        $this->post(route('api.role-abilities.store', ['role' => $role->id]), ['data' => $abilities->toArray()])
            ->assertSuccessful();
    ...
    public function an_admin_can_remove_an_ability_from_a_role(): void
    {
        ...
        $this->delete(route('api.role-abilities.destroy', ['role' => $role->id]), ['data' => [$ability->toArray()]])
            ->assertSuccessful();
    ...
    public function an_admin_can_remove_multiple_abilities_from_a_role(): void
    {
        ...
        $this->delete(route('api.role-abilities.destroy', ['role' => $role->id]), ['data' => $abilities->toArray()])
            ->assertSuccessful();
    ...
    public function data_key_is_required_to_add_ability(): void
    {
        ...
        $this->post(route('api.role-abilities.store', ['role' => $role->id]), ['data' => null])
    ...
    public function data_key_is_required_to_remove_ability(): void
    {
        ...
        $this->delete(route('api.role-abilities.destroy', ['role' => $role->id]), ['data' => null])
            ->assertSessionHasErrors('data')
            ->assertRedirect(route('roles'));
    ...
    public function data_key_to_add_ability_must_be_an_array(): void
    {
        ...
        $this->post(route('api.role-abilities.store', ['role' => $role->id]), ['data' => $ability->name])
            ->assertSessionHasErrors('data')
            ->assertRedirect(route('roles'));
    ...
    public function data_key_to_remove_ability_must_be_an_array(): void
    {
        ...
        $this->delete(route('api.role-abilities.destroy', ['role' => $role->id]), ['data' => $ability->name])
            ->assertSessionHasErrors('data')
            ->assertRedirect(route('roles'));
    ...
    public function ability_name_to_add_is_required(): void
    {
        ...
        $this->post(route('api.role-abilities.store', ['role' => $role->id]), ['data' => ['name' => null]])
    ...
    public function ability_name_to_remove_is_required(): void
    {
        ...
        $this->delete(route('api.role-abilities.destroy', ['role' => $role->id]), ['data' => ['name' => null]])
            ->assertSessionHasErrors('data.*.name')
            ->assertRedirect(route('roles'));
    ...
    public function ability_name_to_add_must_exists(): void
    {
        ...
        $this->post(route('api.role-abilities.store', ['role' => $role->id]), ['data' => ['name' => 'not_existing']])
            ->assertSessionHasErrors('data.*.name')
            ->assertRedirect(route('roles'));
    ...
    public function ability_name_to_remove_must_exists(): void
    {
        ...
        $this->delete(route('api.role-abilities.destroy', ['role' => $role->id]), ['data' => ['name' => 'not_existing']])
            ->assertSessionHasErrors('data.*.name')
            ->assertRedirect(route('roles'));
